...
CHAPTERS_DATA = [
    ...
    },
    {
        ...
        "paragraphs": [
            ...
            {"id": "B", "text": "Dizem que o Mapinguari era um antigo índio guerreiro, uma figura poderoza e forte, que descobriu o segredo da imortalidade. Mas a magia teve um preço terrível."},
    ...
    },
    {
        ...
        "paragraphs": [
            ...
            {"id": "C", "text": "A mãe, inosente, jogou a serpente no rio com medo. Lá, no silénsio da noite, ela se alimentava dos peixes e de qualquer animau selvajem que caísse na água."},
    ...
    },
    {
        ...
        "paragraphs": [
            ...
            {"id": "B", "text": "Naiá era uma jovem índia inosente que se apaixonou por Jaci, a lua. Ela sonhava em ser transformada em uma estrela brilhante no céu, ao lado de Jaci."},
            ...
            {"id": "D", "text": "Toda noite, ela corria pelas matas tentando enchergar a lua. A bela índia ficava triste quando não conseguia, sentindo uma enorme emossão."},
